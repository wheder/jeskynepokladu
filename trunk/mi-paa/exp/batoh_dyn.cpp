...
int main(int argc, char *argv[])
{
	...
	for (int inst=0; inst < instances_count; ++inst) {
		...
		int opak_hmostnost = max_hmotnost;
		while (opak_hmostnost<TOTALREPEAT) {
			opak_hmostnost = opak_hmostnost*10;
			MAXREPEAT = MAXREPEAT * 10;
		}
